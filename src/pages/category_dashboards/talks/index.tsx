...
import { IconTalk, IconTalker, IconOutgoindSpeaker } from '@icons/index';

const TalksDashboard = () => {
  const { t } = useAppTranslation();
  const navigate = useNavigate();

  const { isElder, isWeekendEditor, isPublicTalkCoordinator, isAppointed } =
    useCurrentUser();
      ...
      <div className="tile-grid">
        ...
        {(isElder || isWeekendEditor || isPublicTalkCoordinator) && (
          <button
            ...
            onClick={() => handleTileClick('/public-talks-list')}
          >
            <div className="ti">
            ...
            <div className="tile-body">
              <div className="tile-name">
                {t('tr_publicTalksList', 'Lista de discursos públicos')}
              </div>
            </div>
            <svg
              className="chev-icon"
        ...
        {(isAppointed || isPublicTalkCoordinator) && (
          <button
            type="button"
            className="tile-item c-blue active-press full-width"
            onClick={() => handleTileClick('/speakers-catalog')}
          >
            <div className="ti">
        ...
        {(isAppointed || isPublicTalkCoordinator) && (
          <button
            type="button"
            className="tile-item c-blue active-press full-width"
            onClick={() => handleTileClick('/outgoing-speakers')}
          >
            <div className="ti">
              <IconOutgoindSpeaker
                color="var(--brand)"
            ...
            <div className="tile-body">
              <div className="tile-name">
                {t('tr_outgoingTalks', 'Oradores salientes')}
              </div>
            </div>
            <svg
              className="chev-icon"
