 ...
 *
 * A los 6 segundos aparece un aviso. La app se puede quedar de verdad colgada
 * en este logotipo si la llamada de arranque no vuelve (pasa sin conexión, o
 * con la red de un hotel de por medio), y sin esto no se distingue de "va
 * lento": el usuario se queda mirando un icono que respira, sin saber si
 * esperar o cerrar. No reintenta ni recarga solo — solo lo dice.
 */
