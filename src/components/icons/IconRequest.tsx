...
const IconRequest = ({
  ...
  return (
    <SvgIcon
      className={`organized-icon-request ${className}`}
    ...
    >
      ...
      >
        ...
        <g mask="url(#mask0_2568_27264)">
          ...
          />
          <path
            d="M13.0543 14.6005L12.0005 15.6543L8.34668 12.0005L12.0005 8.34668L13.0543 9.40051L11.2197 11.2505H15.6543V12.7505H11.2197L13.0543 14.6005Z"
            fill={color}
          />
        </g>
      </svg>
