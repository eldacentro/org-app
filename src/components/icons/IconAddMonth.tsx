...
const IconAddMonth = ({
  ...
  // Cada icono necesita su propio id de máscara — si dos instancias del
  // mismo icono se renderizan en la misma página (p. ej. un botón por
  // tarjeta de evento), un id fijo hace que el navegador solo respete el
  // de la primera instancia y las demás queden invisibles.
  const maskId = `mask-add-month-${useId()}`;
