...
const IconResume = ({
  ...
  return (
    <SvgIcon
      className={`organized-icon-resume ${className}`}
    ...
    >
      ...
      >
        <mask
          ...
          height="25"
        >
          <path d="M0 0.000488281H24V24.0005H0V0.000488281Z" fill="#D9D9D9" />
          <path
            d="M14.596 15.7505H13.0961V8.25052H14.596V15.7505Z"
            fill="#D9D9D9"
          />
        </mask>
        <g mask="url(#mask0_3904_134786)">
          ...
          />
          <path
            d="M17.6909 12.0003L11.7949 15.7867V8.21387L17.6909 12.0003Z"
            fill={color}
          />
          <path
            d="M10.0151 15.7504H8.51514V8.25049H10.0151V15.7504Z"
            fill={color}
          />
        </g>
      </svg>
