...
const IconAssign = ({
  ...
  return (
    <SvgIcon
      className={`organized-icon-assign ${className}`}
    ...
    >
      ...
      >
        ...
        <g mask="url(#mask0_2457_21225)">
          ...
          />
          <path
            d="M10.9462 9.40047L12 8.34665L15.6538 12.0005L12 15.6543L10.9462 14.6005L12.7808 12.7504L8.34616 12.7504L8.34616 11.2505L12.7808 11.2505L10.9462 9.40047Z"
            fill={color}
          />
        </g>
      </svg>
