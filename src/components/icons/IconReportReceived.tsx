...
const IconReportReceived = ({
  ...
  return (
    <SvgIcon
      className={`organized-icon-report-received ${className}`}
...
export default IconReportReceived;
