  ...
  return (
    <Box sx={{ width: '100%', maxWidth: 'var(--dash-measure)', margin: '0 auto', paddingTop: '16px' }}>
      ...
      <div className="hello-greeting" style={{ animation: 'none' }}>
        <Skeleton variant="text" width="60%" height={40} sx={{ borderRadius: 'var(--shape-sm)' }} />
        <Skeleton variant="text" width="40%" height={24} sx={{ borderRadius: 'var(--shape-sm)', marginTop: '6px' }} />
      </div>

      {/* MY ASSIGNMENTS SHORTCUT SKELETON */}
      <div className="assign-card" style={{ cursor: 'default', animation: 'none' }}>
        <div className="ic">
          <Skeleton variant="rectangular" width={24} height={24} sx={{ borderRadius: 'var(--shape-sm)', backgroundColor: 'rgba(255, 255, 255, 0.2)' }} />
        </div>
        <div className="txt">
      ...
      <div className="week-card" style={{ animation: 'none' }}>
        <div className="week-head-section">
          ...
          <Skeleton variant="rectangular" width="120px" height={28} sx={{ borderRadius: 'var(--shape-full)' }} />
        </div>
        
        {/* Row 1 */}
        <div className="meeting-row" style={{ cursor: 'default' }}>
          <Skeleton variant="rectangular" width={54} height={58} sx={{ borderRadius: 'var(--shape-sm)' }} />
          <div className="meeting-info">
            <Skeleton variant="text" width="40%" height={20} />
            <Skeleton variant="text" width="60%" height={16} sx={{ marginTop: '4px' }} />
          </div>
          <Skeleton variant="rectangular" width={50} height={28} sx={{ borderRadius: 'var(--shape-full)' }} />
        </div>
        ...
        <div style={{ margin: '6px' }}>
          <Skeleton variant="rectangular" width="100%" height={48} sx={{ borderRadius: 'var(--shape-sm)' }} />
        </div>
      </div>
      ...
      <div className="tile-grid">
        ...
        <div className="tile-item c-blue" style={{ cursor: 'default', animation: 'none' }}>
          <div className="ti">
            <Skeleton variant="rectangular" width={24} height={24} sx={{ borderRadius: 'var(--shape-sm)' }} />
          </div>
          <div>
