  ...
  return (
    <Box sx={{ width: '100%', maxWidth: '600px', margin: '0 auto', paddingTop: '16px' }}>
      ...
      <div className="hello-greeting" style={{ animation: 'none' }}>
        <Skeleton variant="text" width="60%" height={40} sx={{ borderRadius: '8px' }} />
        <Skeleton variant="text" width="40%" height={24} sx={{ borderRadius: '6px', marginTop: '6px' }} />
      </div>

      {/* MY ASSIGNMENTS SHORTCUT SKELETON */}
      <div className="assign-card" style={{ cursor: 'default', animation: 'none' }}>
        <div className="ic">
          <Skeleton variant="rectangular" width={24} height={24} sx={{ borderRadius: '6px', backgroundColor: 'rgba(255, 255, 255, 0.2)' }} />
        </div>
        <div className="txt">
      ...
      <div className="week-card" style={{ animation: 'none' }}>
        <div className="week-head-section">
          ...
          <Skeleton variant="rectangular" width="120px" height={28} sx={{ borderRadius: '999px' }} />
        </div>
      ...
      <div className="tile-grid">
        ...
        <div className="tile-item c-blue" style={{ cursor: 'default', animation: 'none' }}>
          <div className="ti">
            <Skeleton variant="rectangular" width={24} height={24} sx={{ borderRadius: '6px' }} />
          </div>
          <div>
