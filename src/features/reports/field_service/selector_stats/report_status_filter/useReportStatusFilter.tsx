...
const useReportStatusFilter = () => {
  ...
  const options = [
    ...
    {
      key: 'not_submitted' as ReportStatusFilterOption,
      name: t('tr_reportNotSubmitted'),
    },
    {
      key: 'unverified' as ReportStatusFilterOption,
      name: t('tr_reportUnverified'),
    },
    {
      key: 'verified' as ReportStatusFilterOption,
      name: t('tr_reportVerified'),
    },
  ];

  const handleChangeFilter = (value: ReportStatusFilterOption) =>
    setFilter(value);
