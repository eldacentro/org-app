...
const PersonsList = () => {
  ...
  return (
    ...
    >
      ...
      {/* La papelera NO es una pestaña. Se abre unas pocas veces al año y aquí
          tenía el mismo peso que lo que se usa a diario; vive en su página, y
          se entra por el botón de la cabecera. */}
